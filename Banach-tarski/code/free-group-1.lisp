...
(defthmd weak-wordp-b-word
  (implies (integerp n)
	   (weak-wordp (b-word n))
	   )
  )

(defthmd weak-word-b-word-w
  (implies (and (integerp n)
		(weak-wordp w))
	   (weak-wordp (append (b-word n) w)))
  :hints (("Goal"
	   :use ((:instance closure-weak-word (x (b-word n)) (y w))
		 (:instance weak-wordp-b-word (n n)))
	   ))
  )

(defthmd n-mod3-b-n-r-1
  (implies (and (weak-wordp w)
		(integerp n)
		(> n 0))
	   (and (equal 
		 (cons (wb) (append (b-word (- n 1)) w))
		 (append (b-word n) w))
		(equal
		 (append (b-word n) w)
		 (cons (wb) (append (b-word (- n 1)) w)))
...
(encapsulate
 ...
 (local
  (defthmd n-mod3-b-n-r-4
    ...
    :hints (("Goal"
	     :use (
		   (:instance n-mod3-b-n-r-2 (b b) (c c))
		   (:instance mod-+-frgrp (x (* 3 (+ b c))) (y (+ (- c) (- b))) (z 3))
		   (:instance n-mod3-b-n-r-3 (c (+ b c)) (a (+ (- c) (- b))))
		   )
	     :in-theory nil
	     ))
    )
 ...
 (defthmd n-mod3-b-n-r-lemma1
   (IMPLIES (AND (WEAK-WORDP W)
		 (EQUAL (N-MOD3 (APPEND (b-WORD (+ -1 N)) W) X)
			(LIST
			 (MOD (+ (CADR (N-MOD3 W X))
				 (CAR (N-MOD3 W X)))
			      3)
		 ...
		 (> n 1)
		 (< 0 N))
	    (EQUAL (N-MOD3 (APPEND (b-WORD N) W) X)
		   (LIST 
		    (MOD (+ (- (CAR (N-MOD3 W X)))
			    (- (CADR (N-MOD3 W X))))
			 3)
   ...
   :hints (("Goal"
	    :use ((:instance n-mod3-b-n-r-1 (w w) (n n))
		  (:instance weak-word-b-word-w (n (- n 1)) (w w))
		  (:instance integerp-n-mod3 (w w) (x x))
		  (:instance n-mod3-b-r (w (APPEND (b-WORD (+ -1 N)) W)) (x x))
		  (:instance n-mod3-b-n-r-6
			     (x (N-MOD3 (APPEND (b-WORD (+ -1 N)) W) X))
			     (c 0)
			     (a (MOD (+ (CAR (N-MOD3 W X))
					(CADR (N-MOD3 W X)))
				     3))
			     (b (MOD (+ (CADR (N-MOD3 W X))
					(CAR (N-MOD3 W X)))
				     3)))
		  (:instance n-mod3-b-n-r-5 (x (CADR (N-MOD3 W X))) (y (CAR (N-MOD3 W X))))
		  (:instance n-mod3-b-n-r-4 (b (CADR (N-MOD3 W X))) (c (CAR (N-MOD3 W X))))
		  (:instance mod-+-frgrp
			     (x (MOD (+ (CADR (N-MOD3 W (ACL2-SQRT 2)))
					(CAR (N-MOD3 W (ACL2-SQRT 2))))
				     3))
			     (y (MOD (+ (CAR (N-MOD3 W (ACL2-SQRT 2)))
					(CADR (N-MOD3 W (ACL2-SQRT 2))))
				     3))
			     (z 3))
		  (:instance integerp-n-mod3 (w (append (b-word (- n 1)) w)) (x x))
		  (:instance  weak-word-b-word-w (n (- n 1)))
		  )
	    :in-theory (disable mod n-mod3 append weak-wordp b-word acl2-sqrt)
	    ))
   )


 (defthmd n-mod3-b-n-r-lemma2-1
   (implies (integerp x)
	    (equal (- (- x)) x)))

 (defthmd n-mod3-b-n-r-lemma2-2
   (implies (integerp x)
	    (equal (+ x y) (+ y x))))
 
 (defthmd n-mod3-b-n-r-lemma2
   (IMPLIES (AND (WEAK-WORDP W)
		 (EQUAL (N-MOD3 (APPEND (b-WORD (+ -1 N)) W) X)
			(LIST 
			 (MOD (+ (- (CAR (N-MOD3 W X)))
   ...
   :hints (("Goal"
	    :use ((:instance n-mod3-b-n-r-1 (w w) (n n))
		  (:instance weak-word-b-word-w (n (- n 1)) (w w))
		  (:instance n-mod3-b-r (w (append (b-word (- n 1)) w)) (x x))
		  (:instance integerp-n-mod3 (w w) (x x))
		  (:instance n-mod3-b-r (w (APPEND (b-WORD (+ -1 N)) W)) (x x))
		  (:instance n-mod3-b-n-r-6
			     (x (N-MOD3 (APPEND (b-WORD (+ -1 N)) W) X))
			     ...
			     (a (MOD (+ (- (CAR (N-MOD3 W X)))
					(- (CADR (N-MOD3 W X))))
				     3)))
		  (:instance n-mod3-b-n-r-5 (x (- (CADR (N-MOD3 W X)))) (y (- (CAR (N-MOD3 W X)))))
		  (:instance n-mod3-b-n-r-5 (y (- (CADR (N-MOD3 W X)))) (x (- (CAR (N-MOD3 W X)))))
		  (:instance n-mod3-b-n-r-4 (b (- (CADR (N-MOD3 W X)))) (c (- (CAR (N-MOD3 W X)))))
		  (:instance n-mod3-b-n-r-4 (c (- (CADR (N-MOD3 W X)))) (b (- (CAR (N-MOD3 W X)))))
		  (:instance mod-+-frgrp
			     (x (+ (- (CADR (N-MOD3 W (ACL2-SQRT 2))))
				   (- (CAR (N-MOD3 W (ACL2-SQRT 2))))))
			     (y (+ (- (CAR (N-MOD3 W (ACL2-SQRT 2))))
				   (- (CADR (N-MOD3 W (ACL2-SQRT 2))))))
			     (z 3))
		  (:instance mod-+-frgrp
			     (y (+ (- (CADR (N-MOD3 W (ACL2-SQRT 2))))
				   (- (CAR (N-MOD3 W (ACL2-SQRT 2))))))
			     (x (+ (- (CAR (N-MOD3 W (ACL2-SQRT 2))))
				   (- (CADR (N-MOD3 W (ACL2-SQRT 2))))))
			     (z 3))
		  (:instance integerp-n-mod3 (w (append (b-word (- n 1)) w)) (x x))
		  (:instance  weak-word-b-word-w (n (- n 1)))
		  (:instance n-mod3-b-n-r-lemma2-1 (x (CAR (N-MOD3 W (ACL2-SQRT 2)))))
		  (:instance n-mod3-b-n-r-lemma2-1 (x (CADR (N-MOD3 W (ACL2-SQRT 2)))))
		  (:instance n-mod3-b-n-r-lemma2-2
			     (x (CAR (N-MOD3 W (ACL2-SQRT 2))))
			     (y (CADR (N-MOD3 W (ACL2-SQRT 2)))))
		  )
	    :in-theory nil
 ...
 (defthmd n-mod3-b-n-r
   (implies (and (weak-wordp w)
		 (equal x (acl2-sqrt 2))
		 (integerp n)
		 (> n 0))
	    (or (equal (n-mod3 (append (b-word n) w) x)
		       (cons (mod (+ (- (car (n-mod3 w x)))  (- (car (cdr (n-mod3 w x))))) 3)
			     (cons (mod (+ (- (car (cdr (n-mod3 w x)))) (- (car (n-mod3 w x)))) 3) (cons 0 nil))))
		(equal (n-mod3 (append (b-word n) w) x)
		       (cons (mod (+ (car (n-mod3 w x)) (car (cdr (n-mod3 w x)))) 3)
   ...
   :hints (("Goal"
	    :in-theory (disable mod n-mod3 weak-wordp acl2-sqrt)
	    )
	   ...
	   ("Subgoal *1/2.2"
	    :use ((:instance n-mod3-b-n-r-lemma1)
		  (:instance n-mod3-b-n-r-lemma2)
		  (:instance n-mod3-b-n-r=*1/2.2 (n n)))
	    )
...
(defun b-inv-word (n)
  (cond ((zp n) nil)
	(t (cons #\d (b-inv-word (- n 1)))))
  )


(defthmd weak-wordp-b-inv-word
  (implies (integerp n)
	   (weak-wordp (b-inv-word n))
	   )
  )

(defthmd weak-word-b-inv-word-w
  (implies (and (integerp n)
		(weak-wordp w))
	   (weak-wordp (append (b-inv-word n) w)))
  :hints (("Goal"
	   :use ((:instance closure-weak-word (x (b-inv-word n)) (y w))
		 (:instance weak-wordp-b-inv-word (n n)))
	   ))
  )

(defthmd n-mod3-b-inv-n-r-1
  (implies (and (weak-wordp w)
		(integerp n)
		(> n 0))
	   (and (equal 
		 (cons (wb-inv) (append (b-inv-word (- n 1)) w))
		 (append (b-inv-word n) w))
		(equal
		 (append (b-inv-word n) w)
		 (cons (wb-inv) (append (b-inv-word (- n 1)) w)))
		)
...
(encapsulate
 ...
 (local
  (defthmd n-mod3-b-inv-n-r-2
    ...
    :hints (("Goal"
	     :use (
		   (:instance mod3-b-inv-n-r-2-1 (b b) (c c))
		   (:instance mod-+-frgrp (x (* 3 (- b c))) (y (- c b)) (z 3))
		   (:instance mod--frgrp (x c) (y b) (z 3))
		   (:instance n-mod3-b-inv-n-r-2-2 (c (- b c)) (a (- c b)))
		   )
	     :in-theory nil
	     ))
    )
 ...
 (defthmd n-mod3-b-inv-n-r1/2.2.1-1-1
   (implies (equal x (list a b c))
	    (and (equal (car x) a)
		 (equal (cadr x) b)
		 (equal (caddr x) c)))
 ...
 (defthmd n-mod3-b-inv-n-r1/2.2.1-1-2
   (implies (and (integerp x)
		 (integerp y))
	    (integerp (- x y)))
   )

 (defthmd n-mod3-b-inv-n-r1/2.2.1-1-3
   (equal (+ (+ x
		(- y))
	     (- (+ y
		   (- x))))
 ...
 (defthmd n-mod3-b-inv-n-r1/2.2.1-lemma1
   (IMPLIES (AND (WEAK-WORDP W)
		 (EQUAL (N-MOD3 (APPEND (b-inv-WORD (+ -1 N)) W) X)
			(LIST 
			 (MOD (+ (CADR (N-MOD3 W X))
				 (- (CAR (N-MOD3 W X))))
			      3)
		 ...
		 (> n 1)
		 (< 0 N))
	    (EQUAL (N-MOD3 (APPEND (b-inv-WORD N) W) X)
		   (LIST 
		    (MOD (+ (CAR (N-MOD3 W X))
			    (- (CADR (N-MOD3 W X))))
			 3)
   ...
   :hints (("Goal"
	    :use ((:instance n-mod3-b-inv-n-r1/2.2.1-1-2 (x (CADR (N-MOD3 W X))) (y (CAR (N-MOD3 W X))))
		  (:instance n-mod3-b-inv-n-r1/2.2.1-1-2 (y (CADR (N-MOD3 W X))) (x (CAR (N-MOD3 W X))))
		  (:instance n-mod3-b-inv-n-r1/2.2.1-1-3 (x (CADR (N-MOD3 W X))) (y (CAR (N-MOD3 W X))))
		  (:instance n-mod3-b-inv-n-r1/2.2.1-1-3 (y (CADR (N-MOD3 W X))) (x (CAR (N-MOD3 W X))))
		  (:instance n-mod3-b-inv-n-r-1 (w w) (n n))
		  (:instance weak-word-b-inv-word-w (n (- n 1)) (w w))
		  (:instance n-mod3-b-inv-r (w (append (b-inv-word (- n 1)) w)) (x x))
		  (:instance integerp-n-mod3 (w w) (x x))
		  (:instance mod--frgrp-1
			     (x (+ (CADR (N-MOD3 W X))
				   (- (CAR (N-MOD3 W X)))))
		  ...
		  (:instance n-mod3-b-inv-n-r-2 (b (CADR (N-MOD3 W X))) (c (CAR (N-MOD3 W X))))
		  (:instance n-mod3-b-inv-n-r-2 (c (CADR (N-MOD3 W X))) (b (CAR (N-MOD3 W X))))
		  (:instance n-mod3-b-inv-1/2.2-1 (n n))
		  (:instance integerp-n-mod3 (w (append (b-inv-word (- n 1)) w)) (x x))
		  (:instance n-mod3-b-inv-n-r1/2.2.1-1-1 (x (N-MOD3 (APPEND (b-inv-WORD (+ -1 N)) W)
								    (ACL2-SQRT 2)))
			     (c 0)
			     (a (MOD (+ (CADR (N-MOD3 W (ACL2-SQRT 2)))
					(- (CAR (N-MOD3 W (ACL2-SQRT 2)))))
				     3))
			     (b (MOD (+ (CAR (N-MOD3 W (ACL2-SQRT 2)))
					(- (CADR (N-MOD3 W (ACL2-SQRT 2)))))
				     3)))
 ...
 (defthmd n-mod3-b-inv-n-r1/2.2.1-lemma2
   (IMPLIES (AND (WEAK-WORDP W)
		 (EQUAL (N-MOD3 (APPEND (b-inv-WORD (+ -1 N)) W) X)
			(LIST 
			 (MOD (+ (CAR (N-MOD3 W X))
	    ...
	    :use ((:instance n-mod3-b-inv-n-r1/2.2.1-1-2 (x (CADR (N-MOD3 W X))) (y (CAR (N-MOD3 W X))))
		  ...
		  (:instance n-mod3-b-inv-n-r1/2.2.1-1-1 (x (N-MOD3 (APPEND (b-inv-WORD (+ -1 N)) W)
			     ...
			     (b (MOD (+ (CADR (N-MOD3 W (ACL2-SQRT 2)))
					(- (CAR (N-MOD3 W (ACL2-SQRT 2)))))
				     3))
			     (a (MOD (+ (CAR (N-MOD3 W (ACL2-SQRT 2)))
					(- (CADR (N-MOD3 W (ACL2-SQRT 2)))))
				     3)))
		  
		  )
	    :in-theory nil
					;(disable mod n-mod3 n-f acl2-sqrt weak-wordp b-inv-word append)
	    :do-not-induct t
	    ))
 ...
 (defthmd n-mod3-b-inv-n-r
   (implies (and (weak-wordp w)
		 (equal x (acl2-sqrt 2))
		 (integerp n)
		 (> n 0))
	    (or (equal (n-mod3 (append (b-inv-word n) w) x)
		       (cons (mod (- (car (n-mod3 w x)) (car (cdr (n-mod3 w x)))) 3)
			     (cons (mod (- (car (cdr (n-mod3 w x))) (car (n-mod3 w x))) 3) (cons 0 nil))))
		(equal (n-mod3 (append (b-inv-word n) w) x)
		       (cons (mod (- (car (cdr (n-mod3 w x))) (car (n-mod3 w x))) 3)
			     (cons (mod (- (car (n-mod3 w x)) (car (cdr (n-mod3 w x)))) 3) (cons 0 nil))))))
   ...
   :hints (("Goal"
	   ...
	   ("Subgoal *1/2.2"
	    :use ((:instance n-mod3-b-inv-n-r1/2.2.1-lemma2)
		  (:instance n-mod3-b-inv-n-r1/2.2.1-lemma1)
		  (:instance n-mod3-b-inv-1/2.2-1 (n n)))
	    :in-theory nil
	    )
